...
use App\Controller\Admin\TestimonyCrudController;
use EasyCorp\Bundle\EasyAdminBundle\Test\AbstractCrudTestCase;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\Security\Core\User\InMemoryUser;

final class TestimonyCrudControllerTest extends AbstractCrudTestCase
{
    protected function getControllerFqcn(): string
    {
        return TestimonyCrudController::class;
    }
    ...
    {
        $this->client->request('GET', $this->generateEditFormUrl(16));
        static::assertResponseRedirects('/login', 302);
    }

    public function testDetailPageNotlogged(): void
    {
        $this->client->request('GET', $this->generateDetailUrl(16));
        static::assertResponseRedirects('/login', 302);
    }
